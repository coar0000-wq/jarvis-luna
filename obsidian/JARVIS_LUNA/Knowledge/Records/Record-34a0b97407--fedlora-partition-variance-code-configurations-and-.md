...
updated_at: 2026-09-21T22:01:00.932615+00:00
tags: [record, real-data]
---

# Record 34a0b97407 · fedlora-partition-variance-code-configurations-and-run-artifacts-for-P

> 실제 수집 레코드입니다. 원문: [arxiv.org](https://arxiv.org/abs/2609.13512)

**제목:** fedlora-partition-variance: code, configurations, and run artifacts for Partition Draws, Not Aggregators

fedlora-partition-variance: code, configurations, and run artifacts for Partition Draws, Not Aggregators
