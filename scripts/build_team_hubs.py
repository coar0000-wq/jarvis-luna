...
# 전 팀 공통 지시. 모든 팀 노트에 같은 문구로 들어간다.
#
# 2026-09-16 사용자가 모든 팀원에게 전해달라고 한 내용이다.
# 팀 노트는 매 회차 다시 만들어지므로 노트에 손으로 적으면 지워진다.
# 그래서 생성기에 둔다. 상세 조항과 근거는 CLAUDE.md 에 있다.
TEAM_MISSION = """## 공통 지시 · 재귀적 자기개선
